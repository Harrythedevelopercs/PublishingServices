                ...
                <div className='container'>
                    <div className="grid lg:grid-cols-2 grid-cols-1 gap-x-5 gap-y-8">
                        <div className='flex justify-center flex-col'>
                            <h1 className='md:text-[20px] text-[18px] font-montserrat font-bold text-white uppercase'>Book Translation Service</h1>
                        ...
                        <div className='max-w-[500px] lg:ms-auto lg:mx-0 mx-auto relative  pb-10 '>
                            <div className='bg-white py-[50px] px-[35px] rounded-xl shadow-xl'>
                                <div className='flex flex-col justify-center text-center items-center'>
                                    ...
                                    <h2 className='font-comfortaa font-bold xl:text-[33px] md:text-[28px] text-[23px] text-primary'>Book Translation Service</h2>
                                    ...
                                    <div className='flex flex-row gap-x-1 w-full justify-between mt-5 '>
                                        <div className='border-2 border-primary py-[10px] pl-[10px] pr-[30px]'>
                                            <h5 className='text-[#A8A8A8] font-comfortaa lg:text-[16px] md:text-[15px] text-xs'>From</h5>
                                            <h3 className='text-primary font-bold font-comfortaa md:text-[28px] text-[20px]'>$0.07</h3>
                                            <h5 className='text-[#A8A8A8] font-comfortaa lg:text-[16px] md:text-[15px] text-xs'>per word</h5>
                                        </div>
                                        <div className='border-2 border-primary py-[10px] pl-[10px] pr-[30px]'>
                                            <h5 className='text-[#A8A8A8] font-comfortaa lg:text-[16px] md:text-[15px] text-xs'>From</h5>
                                            <h3 className='text-primary font-bold font-comfortaa md:text-[28px] text-[20px]'>$0.08</h3>
                                            <h5 className='text-[#A8A8A8] font-comfortaa lg:text-[16px] md:text-[15px] text-xs'>per minute</h5>
                                        </div>
                                        <div className='border-2 border-primary py-[10px] pl-[10px] pr-[30px]'>
                                            <h5 className='text-[#A8A8A8] font-comfortaa lg:text-[16px] md:text-[15px] text-xs'>Turnaround</h5>
                                            <h3 className='text-primary font-bold font-comfortaa md:text-[28px] text-[20px]'>1-3 Day</h3>
                                        </div>
                                    </div>
