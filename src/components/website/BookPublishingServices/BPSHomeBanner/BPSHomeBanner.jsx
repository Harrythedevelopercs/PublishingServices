        ...
        <div className="container">
          <div className="grid lg:grid-cols-2 grid-cols-1 gap-x-5 gap-y-8">
            <div className="flex justify-center flex-col">
              <h1 className="xl:text-[20px] md:text-[18px] sm:text-[16px] text-[13px] font-montserrat font-bold text-white uppercase">
              ...
              <p className="xl:text-[18px] lg:text-[16px] md:text-[15px] text-[14px] font-comfortaa mt-4 text-white">
            ...
            <div className="max-w-[500px] lg:ms-auto lg:mx-0 mx-auto relative pb-10 ">
              <div className="bg-white py-10 px-3 lg:rounded-b-xl rounded-xl">
                <div className="flex  justify-center items-end content-center gap-3">
                  ...
                  <div>
                    <h3 className="text-secondary text-[13px] font-comfortaa leading-none mb-1">
                      Fill Out This Brief Form To Get Your
                    </h3>
                    <p className="text-secondary text-[23px] font-montserrat font-semibold leading-none">
                      Discount Reserved
                    </p>
                  </div>
                </div>
                <div className="sm:px-12 px-5 mt-10">
                  <form action="">
                    <div className="flex flex-col gap-3">
                      ...
                      <input
                        type="submit"
                        className="bg-primary font-montserrat uppercase text-white font-bold block w-full text-center h-12 rounded-md"
