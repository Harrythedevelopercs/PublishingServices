                            ...
                            [
                                {
                                    ...
                                    descp: "Do you need a trusted team to refine your writing and make it flawless? Our skilled editors are ready to elevate your script with precision and utmost care."
                                },
                                {
                                    icon: publish,
                                ...
                                <div key={i} className='bg-[#F2F2F2] 2xl:basis-[18%] xl:basis-[25%] lg:basis-[30%] md:basis-[48%] basis-[100%] p-7 flex flex-col justify-center content-center items-center'>
                                    <Image src={icon} alt="BPS" />
                                    <h4 className='text-[20px] font-montserrat font-bold text-secondary capitalize text-center mt-4'>{title}</h4>
