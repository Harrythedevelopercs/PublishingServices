                    ...
                    <div className='container'>
                        <div className="grid md:grid-cols-2 grid-cols-1 gap-x-5 gap-y-8">
                            ...
                            <div className='flex flex-col justify-center '>
                                ...
                                <p className='xl:text-[16px] md:text-[15px] text-sm font-comfortaa mt-4'> We'll help you turn your masterpiece into the next best-seller.</p>
                ...
                <div className='lg:py-[80px] py-[50px]'>
                    <div className='container'>
                        <div className='grid lg:grid-cols-2 grid-cols-1 gap-x-5 gap-y-14'>
                            <div className='flex flex-col justify-center'>
                                <h2 className='font-montserrat font-bold xl:text-[40px] lg:text-[35px]  md:text-[30px] sm:text-[25px] text-[20px] text-secondary leading-tight'>Can't Wait For Your <br />Manuscript To Get <br /> Published?</h2>
                                <p className='xl:text-[16px] md:text-[15px] text-sm font-comfortaa mt-4'>We are here for you. At Divine Ghostwriters, we offer complete book writing and publishing solutions. Our services include:</p>
                                <div className='grid sm:grid-cols-2 grid-cols-1 gap-y-5 mt-4'>
                                    {
                                        [
                                            ...
                                            <div className='flex gap-x-3 items-center content-center xl:text-[16px] md:text-[15px] text-sm' key={i}>
