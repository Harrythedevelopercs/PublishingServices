                    ...
                    <div className="overflow-hidden mt-16" ref={emblaRef}>
                        <div className="flex [margin-left:calc(1rem_*_-1)]">
                            <div className="pl-2 grow-0 shrink-0 xs:basis-1/2 sm:basis-1/2 md:basis-1/3 lg:basis-1/5 px-4 ">
                                ...
                                <p className='font-comfortaa  lg:px-8 text-[12px] text-center mt-5'>NYT Bestseller by Cast of NBC’s The Office</p>
                            </div>
                            <div className="pl-2 grow-0 shrink-0 xs:basis-1/2 sm:basis-1/2 md:basis-1/3 lg:basis-1/5 px-4">
                                <Image src={B2} alt="booksWorld" className='mx-auto' />
                                <p className='font-comfortaa  lg:px-8 text-[12px] text-center mt-5'>#1 WSJ Bestseller by Billionaire Founder of Paychex</p>
                            </div>
                            <div className="pl-2 grow-0 shrink-0 xs:basis-1/2 sm:basis-1/2 md:basis-1/3 lg:basis-1/5 px-4">
                                <Image src={B3} alt="booksWorld" className='mx-auto' />
                                <p className='font-comfortaa  lg:px-8 text-[12px] text-center mt-5'>#1 NYT Bestseller with 3,000,000+ Copies Sold</p>
                            </div>
                            <div className="pl-2 grow-0 shrink-0 xs:basis-1/2 sm:basis-1/2 md:basis-1/3 lg:basis-1/5 px-4">
                                <Image src={B4} alt="booksWorld" className='mx-auto' />
                                <p className='font-comfortaa  lg:px-8 text-[12px] text-center mt-5'>Bestselling Author With 8,000,000+ Copies Sold Worldwide</p>
                            </div>
                            <div className="pl-2 grow-0 shrink-0 xs:basis-1/2 sm:basis-1/2 md:basis-1/3 lg:basis-1/5 px-4">
                                <Image src={B5} alt="booksWorld" className='mx-auto' />
                                <p className='font-comfortaa  lg:px-8 text-[12px] text-center mt-5'>NYT Bestselling Memoir, 100,000+ Copies Sold</p>
                            </div>
