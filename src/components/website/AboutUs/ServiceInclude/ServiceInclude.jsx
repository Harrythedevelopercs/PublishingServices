            ...
            <div className='container lg:py-[60px]'>
                <div className='grid grid-cols-1 md:grid-cols-2'>
                    ...
                    <div className='py-[40px]'>
                        <h2 className='text-[4.5dvh]  sm:text-[25px] md:text-[30px] lg:text-[40px] xl:text-[50px] 2xl:text-[60px] font-montserrat font-bold capitalize text-secondary leading-[1.1] text-right'>Our Specialists Are Always in Demand</h2>
                        <p className='text-secondary font-comfortaa text-[12px] sm:text-[13px] md:text-[14px] lg:text-[15px] xl:text-[18px] 2xl:text-[20px] mt-5  font-bold sm:font-normal text-right'>Ever wondered what makes a story truly captivating? It combines linguistic finesse, creative brilliance, and technical know-how perfectly.</p>
                        <div className='mt-4 '>
