...
import { ContactForm, CTA, TSHeroBanner } from '../components'
        ...
        <div>
            ...
            <section>
                <div className='py-[80px]'>
                    <div className='container'>
                        <h2 className='font-montserrat font-bold text-secondary text-[40px] text-center'>Since 2005: Used & Trusted by <span className='text-primary'>144,000 Satisfied Clients</span></h2>
                        <div className='grid grid-cols-6 h-[80px] gap-10 mt-10'>
                            <Image src={B1} alt='BPS' className='aspect-[15/4]' />
                            <Image src={B2} alt='BPS' className='aspect-[15/4]' />
                            <Image src={B3} alt='BPS' className='aspect-[15/4]' />
                            <Image src={B4} alt='BPS' className='aspect-[15/4]' />
                            <Image src={B5} alt='BPS' className='aspect-[15/4]' />
                            <Image src={B6} alt='BPS' className='aspect-[15/4]' />
                        </div>
                        <div className='grid grid-cols-6 h-[80px] gap-10 mt-10'>
                            <Image src={B7} alt='BPS' className='aspect-[15/4]' />
                            <Image src={B8} alt='BPS' className='aspect-[15/4]' />
                            <Image src={B9} alt='BPS' className='aspect-[15/4]' />
                            <Image src={B10} alt='BPS' className='aspect-[15/4]' />
                            <Image src={B11} alt='BPS' className='aspect-[15/4]' />
                            <Image src={B12} alt='BPS' className='aspect-[15/4]' />
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section>
                <div className='py-[40px]'>
                    <div className='container'>
                        <h2 className='font-montserrat font-bold text-[40px]'>We are fluent in:</h2>
                        <div className='grid grid-cols-9 h-[80px] gap-10 mt-10'>
                        ...
                        <div className='grid grid-cols-9 h-[80px] gap-10 mt-16'>
            ...
            <section>
                <div className='py-[60px]'>
                    <div className='container'>
                        <h2 className='font-montserrat font-bold text-[40px]'>How it works?</h2>
                        <div className='grid grid-cols-3 gap-10 mt-10'>
                            <div className='bg-[#F2F2F2] py-[30px] flex flex-col justify-center content-center items-center'>
                                <div className='bg-white w-[88px]  h-[88px] rounded-xl flex items-center justify-center '>
                                    <Image src={step1} alt='BPS' className='w-[70%] ' />
                                </div>
                                <h4 className='font-montserrat font-bold text-secondary text-[20px] mt-5'>Step 1</h4>
                                <h4 className='font-montserrat font-bold text-black text-[20px] mt-3'>Upload Files</h4>
                                <p className='font-montserrat text-[13px] font-bold'>Easily via web or link</p>
                            </div>
                            <div className='bg-[#F2F2F2] py-[30px] flex flex-col justify-center content-center items-center'>
                                <div className='bg-white w-[88px]  h-[88px] rounded-xl flex items-center justify-center'>
                                    <Image src={step2} alt='BPS' className='w-[70%] ' />
                                </div>
                                <h4 className='font-montserrat font-bold text-secondary text-[20px] mt-5'>Step 2</h4>
                                <h4 className='font-montserrat font-bold text-black text-[20px] mt-3'>Pay Online</h4>
                                <p className='font-montserrat text-[13px] font-bold'>With major credit card, debit card, or PayPal</p>
                            </div>
                            <div className='bg-[#F2F2F2] py-[30px] flex flex-col justify-center content-center items-center'>
                                <div className='bg-white w-[88px]  h-[88px] rounded-xl flex items-center justify-center'>
                                    <Image src={step3} alt='BPS' className='w-[70%] ' />
                                </div>
                                <h4 className='font-montserrat font-bold text-secondary text-[20px] mt-5'>Step 3</h4>
                                <h4 className='font-montserrat font-bold text-black text-[20px] mt-3'>Get Your Translations</h4>
                                <p className='font-montserrat text-[13px] font-bold'>Delivered via email</p>
                            </div>
                        </div>

                        <div className='grid grid-cols-2 gap-10 mt-10'>
                            <div className='border-2 border-gray-400 rounded-xl p-10'>
                                <p className='font-comfortaa text-[16px]'>There are more than 6,000 languages spoken around the globe. Therefore, translation is critical if you want your content to reach a wider audience. At GoTranscript, we provide high-quality translation services for all types of documents and industries. Our expert translators are available whether you are a business executive, a researcher at a university, a well-known author, or a medical provider. We are here to assist you in spreading your message to international audiences.</p>
                            </div>
                            <div className='border-2 border-gray-400 rounded-xl p-10'>
                                <p className='font-comfortaa text-[16px]'>With a devoted translation team representing more than 70 languages, we are sure that we can handle almost any translation need that may arise. This ability makes us your one-stop shop for your translation needs. Whether you want a translation from Polish, English, Swedish, Norwegian, Romanian, Russian, Thai, Italian, Vietnamese, or Greek, we can help with that. These are just a few of the languages we can help with, so if you don't see the one you are looking for, contact us, and we will go out of our way to accommodate your needs.</p>
                            </div>
                        </div>

                        <div className='mt-20'>
                            <h2 className='font-montserrat text-secondary font-bold text-[60px] text-center'>A Book <span className='text-primary '>Translation Company</span> You Can Trust</h2>
                            <p className='mt-5 font-comfortaa text-[20px]'>Translating your content or material to a foreign language using Google Translate isn't enough. You must ensure that the translation is easy to understand and accurate, particularly if you are operating in multiple markets or dealing with official documents. That's why choosing a reliable translation agency is critical.</p>
                            <div className='mt-16 bg-gray-300 p-8'>
                                <p className=' font-comfortaa text-[18px]'>Translating your content or material to a foreign language using Google Translate isn't enough. You must ensure that the translation is easy to understand and accurate, particularly if you are operating in multiple markets or dealing with official documents. That's why choosing a reliable translation agency is critical.</p>
                            </div>
                            <div className='mt-8 bg-gray-300 p-8'>
                                <p className=' font-comfortaa text-[16px]'>However, finding a document translation company you can trust can be a daunting process. The translation service provider a business or a company decides to work with becomes their voice since it's entrusted with getting their message across to potential multilingual customers. For this to happen, the original intended message must come across with 100% clarity. To get a translation company you can trust, here are some of the qualities to look for</p>
                            </div>
                        </div>
                        ...
                        <div className='mt-20'>
                            <div className='grid grid-cols-12'>
                                <div className='col-span-7 flex flex-col justify-center '>
                                    <h3 className='font-montserrat text-[40px] font-bold'>Bringing Your Book <br /> Dreams to Life with Our <br /> Publishing Service</h3>
                                    <p className='mt-5  font-comfortaa text-[16px]'>
                            ...
                            <div className='grid grid-cols-2 gap-10'>
                                {
                                    [
                                        ...
                                        <div key={i} className='bg-[#F2F2F2] p-12'>
                                            ...
                                            <p className='font-comfortaa text-[16px] mt-5'>{description}</p>
                                        </div>
                                    ))
                                }
                            </div>
                        ...
                        <div className='mt-20'>
                            <div className='grid grid-cols-12'>
                                ...
                                <div className='col-span-6 flex flex-col justify-center '>
                                    <h3 className='font-montserrat text-[40px] font-bold'>How Can We Help?</h3>
                                    <p className='mt-5  font-comfortaa text-[16px]'>
                        ...
                        <div className='mt-10'>
                            <h2 className='text-[60px] font-montserrat font-bold leading-tight'>
                                Why Choose <span className='text-primary'>GoTranscript <br />Book</span> Translation Services
                            </h2>
                            <div className='grid grid-cols-3 gap-10 mt-10'>
                                <div className='bg-[#F2F2F2] py-[30px] flex flex-col justify-center content-center items-center p-10'>
                                    <div className='bg-white w-[88px]  h-[88px] rounded-xl flex items-center justify-center '>
                                        <Image src={anyone} alt='BPS' className='w-[70%] ' />
                                    </div>
                                    <h4 className='font-montserrat font-bold text-secondary text-[20px] mt-5'>Top Quality</h4>
                                ...
                                <div className='bg-[#F2F2F2] py-[30px] flex flex-col justify-center content-center items-center p-10'>
                                    ...
                                    <h4 className='font-montserrat font-bold text-secondary text-[20px] mt-5'>Affordability</h4>
                                ...
                                <div className='bg-[#F2F2F2] py-[30px] flex flex-col justify-center content-center items-center p-10'>
                                    ...
                                    <h4 className='font-montserrat font-bold text-secondary text-[20px] mt-5'>Fast Turnaround</h4>
                            ...
                            <div className='grid grid-cols-3 gap-10 mt-10'>
                                <div className='bg-[#F2F2F2] p-8'>
                                    <h2 className='text-[20px] font-montserrat font-bold '>Professionalism</h2>
                                    <p className='text-[16px] font-comfortaa text-secondary mt-5'>
                                ...
                                <div className='bg-[#F2F2F2] p-8'>
                                    <h2 className='text-[20px] font-montserrat font-bold '>Experience</h2>
                                    <p className='text-[16px] font-comfortaa text-secondary mt-5'>
                                ...
                                <div className='bg-[#F2F2F2] p-8'>
                                    <h2 className='text-[20px] font-montserrat font-bold '>Accuracy</h2>
                                    <p className='text-[16px] font-comfortaa text-secondary mt-5'>
                            ...
                            <div className='grid grid-cols-2 gap-10 mt-10'>
                                <div className='bg-[#F2F2F2] p-8'>
                                    <h2 className='text-[20px] font-montserrat font-bold '>Speed</h2>
                                    <p className='text-[16px] font-comfortaa text-secondary mt-5'>
                                ...
                                <div className='bg-[#F2F2F2] p-8'>
                                    <h2 className='text-[20px] font-montserrat font-bold '>Affordability</h2>
                                    <p className='text-[16px] font-comfortaa text-secondary mt-5'>
                        ...
                        <div className='mt-20'>
                            <div className='grid grid-cols-12'>
                                ...
                                <div className='col-span-6 flex flex-col justify-center '>
                                    <h3 className='font-montserrat text-[40px] font-bold'>Why Should You Translate Your Book?</h3>
                                    <p className='mt-5  font-comfortaa text-[16px]'>
                                ...
                                <div className='col-span-6 flex items-end justify-end'>
                                    <Image src={RIGHCOL} alt="BPS" className='w-[90%]' />
                                </div>
                            ...
                            <div className='grid grid-cols-2 gap-10'>
                                {
                                    [
                                        ...
                                        <div key={i} className='bg-[#F2F2F2] p-12'>
                                            ...
                                            <h3 className='text-[20px] font-montserrat font-bold mt-3'>{title}</h3>
                                            <p className='font-comfortaa text-[16px] mt-2'>{description}</p>
                                        </div>
                                    ))
                                }
                            </div>
