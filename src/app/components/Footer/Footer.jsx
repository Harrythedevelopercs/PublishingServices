            ...
            <div>
                <div className='container'>
                    <div className='grid grid-cols-12 py-[30px]'>
                        ...
                        <div className='mt-5 md:mt-0 col-span-12 md:col-span-9 flex justify-center content-center items-center'>
                            <Image src={awards} alt='Best Publishing Services' />
                        </div>
                    </div>
                    <hr />
                    <div className='flex xs:flex-col xs:gap-5 items-start py-[20px] justify-between px-5'>
                        ...
                        <p className='font-montserrat sm:text-[11px] md:text-[13px] text-secondary  flex gap-3 content-center justify-center items-center'>
                            ...
                            info@bestpublishingservices.com
                        </p>
                        <p className='font-montserrat sm:text-[11px] md:text-[13px] text-secondary  flex gap-3 content-center justify-center items-center'>
                            <svg
                    ...
                    <div className='grid xs:grid-cols-1 xs:gap-5 sm:grid-cols-4 py-[30px] justify-between '>
                        ...
                        <div>
                            ...
                            <ul className="list-none font-montserrat sm:text-[10px] md:text-[13px] lg:text-[15px] space-y-2 text-gray-700">
                                ...
                                <li>Amazon</li>
                                <li>Barn & Noble</li>
                                <li>Lulu Publishing</li>
                                <li>Printing</li>
                                <li>Print on Demand</li>
                                <li>Self-Publishing</li>
                                <li>Paperback Book Printing</li>
                                <li>Hardcover Book Printing</li>
                            </ul>
                        </div>
                        <div>
                            ...
                            <ul className="list-none font-montserrat sm:text-[10px] md:text-[13px] lg:text-[15px] space-y-2 text-gray-700">
                                ...
                                <li>Printed Book Formatting</li>
                                <li>Copy Editing Service</li>
                                <li>Line Editing Service</li>
                            </ul>
                        </div>
                        <div className=''>
