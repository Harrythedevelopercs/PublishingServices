                        ...
                        <div className='flex flex-row gap-5 justify-center content-center mt-10 mx-auto max-w-[90%] flex-wrap'>
                            {
                                [
                                    ...
                                    <div key={i} className='hover:bg-secondary group w-[225px] transition-all duration-500 flex justify-center content-center py-[30px] flex-col rounded-lg flex-wrap border-secondary border-2 hover:scale-90'>
                                        <Image src={Icon} alt="BPS" className='mx-auto brightness-100 invert-1 group-hover:invert ' />
