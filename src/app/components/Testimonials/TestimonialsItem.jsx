...
export default function TestimonialsItem({ImageSrc,Author,Comment}) {
    return (
        <div className=" grow-0 shrink-0 xs:basis-1/3 sm:basis-1/2 md:basis-1/3 lg:basis-1/3 px-4 ">
            <div className='border-[1px] border-solid border-[#E2E2E2] w-[380px] h-[301px] rounded-xl flex flex-col justify-center content-center items-center text-center px-10'>
                ...
                <p className='font-montserrat font-bold text-[13px] text-secondary mt-5'>{Comment}</p>
