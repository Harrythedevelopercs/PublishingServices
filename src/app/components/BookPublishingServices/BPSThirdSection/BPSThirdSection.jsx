                    ...
                    <div className='mt-10 flex flex-row gap-5'>
                        {
                            [
                                ...
                                <div key={i} className='bg-[#F2F2F2] p-7 flex flex-col justify-center content-center items-center'>
