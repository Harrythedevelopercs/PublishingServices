...
export default function CTA({ Text, Href, Primary, bg = "bg-secondary", textColor = "text-white" }) {
  return (
    <>
      {Primary ? (
        <>
        ...
        <>
          <Link
            href={Href}
            className={`relative text-center items-center justify-start inline-blockoverflow-hidden transition-all ${bg}  hover:bg-primary  group w-[45dvw] sm:w-[130px] md:w-[150px] lg:w-[200px] xl:w-[240px] 2xl-w-[280px] h-[30px] sm:h-[30px] md:h-[30px] lg:h-[40px] xl:h-[50px] 2xl:h-[55px] content-center uppercase font-extrabold font-montserrat text-[2.5dvw] sm:text-[10px] md:text-[10px] lg:text-[13px] 2xl:text-[15px]`}
          >
            ...
            <span className={`relative w-full text-left ${textColor}  transition-colors duration-200 ease-in-out group-hover:text-white`}>
              {Text}
            </span>
          </Link>
        </>
