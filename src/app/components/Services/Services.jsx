    ...
    <section className='py-[60px] overflow-hidden'>
      <div className="relative">
        <div className='container'>
          <div className='mt-3 '>
            <h2 className='font-montserrat font-bold xs:text-[6dvw] sm:text-[25px] md:text-[30px] lg:text-[40px] xl:text-[50px] 2xl:text-[60px] text-center'>How We Empower Authors</h2>
          ...
          <ServicesItem direction="right" bookImage={Book1}  Title="Professional Ghostwriting"/>
