      ...
      <section>
        <div className="lg:py-[70px] py-[40px]">
          <div className="container">
            <h2 className="font-montserrat font-bold 2xl:text-[40px] xl:text-[30px] md:text-[25px] text-[20px] text-secondary">
              Find <span className="text-primary">Ghostwriters</span> All Across
              United States
            </h2>
            <div className="mt-5 grid lg:grid-cols-5 md:grid-cols-4 sm:grid-cols-3 grid-cols-2 gap-5">
              {[
                ...
                <p
                  key={i}
                  className="flex gap-5 py-[10px] justify-start items-center"
                >
                  <svg
